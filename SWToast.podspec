#
#  Be sure to run `pod spec lint SWToast.podspec' to ensure this is a
...
根据平时项目的需要在 GSMessages的基础上封装了便利的方法.
  ...
  spec.source_files  = "SWToast", "SWToast/**/*.{h,m,swift}"
  # spec.exclude_files = "SWToast/Exclude"

  # spec.public_header_files = "SWToast/**/*.h"
  ...
  spec.dependency "GSMessages", "~> 1.7.2"
